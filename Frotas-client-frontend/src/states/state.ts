...
class State {
  ...
  public readonly URL: string = import.meta.env.VITE_URL_API ?? ''
  public readonly URL_ACCESS_CONTROL: string =
    import.meta.env.VITE_URL_ACCESS_CONTROL ?? ''
  ...
  public decodeJwt(): void {
    ...
    try {
      ...
      this.Nome = decodedToken.email?.split('@')[0] || ''
