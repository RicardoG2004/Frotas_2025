...
import { filterFields } from '@/pages/base/conservatorias/components/conservatorias-table/conservatorias-constants'
...
export function ConservatoriasFilterControls({
  table,
  columns,
}: BaseFilterControlsProps<ConservatoriaDTO>) {
  ...
  const renderFilterInput = (column: ColumnDef<ConservatoriaDTO, unknown>) => {
