...
import { filterFields } from '@/pages/base/setores/components/setores-table/setores-constants'
...
export function SetoresFilterControls({
  table,
  columns,
}: BaseFilterControlsProps<SetorDTO>) {
  ...
  const renderFilterInput = (column: ColumnDef<SetorDTO, unknown>) => {
