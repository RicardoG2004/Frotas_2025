...
import { useDeleteMultipleSetores } from '../../queries/setores-mutations'
import { columns } from './setores-columns'
import { SetoresFilterControls } from './setores-filter-controls'

type TSetoresTableProps = {
  setores: SetorDTO[]
  page: number
  pageSize: number
  total: number
...
export function SetoresTable({
  ...
  const deleteMultipleSetoresMutation = useDeleteMultipleSetores()
  ...
  const { isDeleteModalOpen, setIsDeleteModalOpen, handleDeleteSelected } =
    useDeleteHandler(
      deleteMultipleSetoresMutation,
      'Setores excluídos com sucesso',
      'Erro ao excluir setores',
      state.selectedRows,
      undefined, // onSuccess callback
      'Alguns setores foram excluídos com avisos', // partial success message
      (deletedIds: string[]) => {
      ...
      {setores && (
        <>
          <DataTable
            ...
            FilterControls={SetoresFilterControls}
            toolbarActions={[
              {
                label: 'Remover',
          ...
          <AlertModal
            ...
            loading={deleteMultipleSetoresMutation.isPending}
            title='Remover Setores'
            description='Tem certeza que deseja remover os setores selecionados?'
          />
        </>
      )}
    </>
