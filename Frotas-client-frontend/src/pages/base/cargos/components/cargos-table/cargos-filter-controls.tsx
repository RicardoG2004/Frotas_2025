...
import { filterFields } from './cargos-constants'

export function CargosFilterControls({
  table,
  columns,
}: BaseFilterControlsProps<CargoDTO>) {
  ...
  const renderFilterInput = (column: ColumnDef<CargoDTO, unknown>) => {
