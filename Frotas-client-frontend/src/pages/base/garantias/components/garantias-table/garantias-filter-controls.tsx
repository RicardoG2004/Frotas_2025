...
import { filterFields } from './garantias-constants'
...
export function GarantiasFilterControls({
  table,
  columns,
}: BaseFilterControlsProps<GarantiaDTO>) {
  ...
  const renderFilterInput = (column: ColumnDef<GarantiaDTO, unknown>) => {
