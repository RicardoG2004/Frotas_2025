...
import { GarantiaCreateForm } from '../garantias-forms/garantia-create-form'

export function GarantiasCreatePage() {
  ...
  return (
    <div className='flex h-full flex-col gap-8 px-4 md:px-8 md:pb-8 md:pt-28 pt-14 md:mx-0 md:my-4 md:mr-4 md:rounded-xl pb-24'>
      <PageHead title='Criar Garantia | Frotas' />
      ...
      <div className='flex items-center gap-4'>
        ...
        <Breadcrumbs
          items={[
            ...
            {
              title: 'Criar',
              link: `/utilitarios/tabelas/configuracoes/garantias/create?instanceId=${instanceId}`,
            },
          ]}
        />
      </div>
      ...
      <div className='rounded-lg border bg-card'>
        <div className='border-b px-6 py-4'>
          <h2 className='text-base font-medium'>Criar Garantia</h2>
        </div>
        <div className='p-6'>
          <GarantiaCreateForm modalClose={handleClose} />
        </div>
      </div>
    </div>
  )
