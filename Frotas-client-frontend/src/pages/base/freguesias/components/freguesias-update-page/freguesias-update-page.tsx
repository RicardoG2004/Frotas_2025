...
import { useGetFreguesia } from '../../queries/freguesias-queries'
...
export function FreguesiasUpdatePage() {
  ...
  useEffect(() => {
    ...
    if (
      freguesiaId &&
      currentWindow &&
      !currentWindow.searchParams?.freguesiaId
    ) {
  ...
  }, [freguesiaId, instanceId, windows])
  ...
  return (
    <div className='flex h-full flex-col gap-8 px-4 md:px-8 md:pb-8 md:pt-28 pt-14 md:mx-0 md:my-4 md:mr-4 md:rounded-xl pb-24'>
      <PageHead title='Atualizar Freguesia | Frotas' />
