import { columns } from '@/pages/base/cores/components/cores-table/cores-columns'
import { CoresFilterControls } from '@/pages/base/cores/components/cores-table/cores-filter-controls'
              ...
              },
              {
                ...
                onClick: () =>
                  handlers.handleCreateClick(
                    '/utilitarios/tabelas/configuracoes/cores'
                  ),
                variant: 'emerald',
              },
            ]}
