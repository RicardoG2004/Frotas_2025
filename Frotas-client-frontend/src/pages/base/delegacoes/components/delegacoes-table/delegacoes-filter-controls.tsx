...
import { filterFields } from '@/pages/base/delegacoes/components/delegacoes-table/delegacoes-constants'
...
export function DelegacoesFilterControls({
  table,
  columns,
}: BaseFilterControlsProps<DelegacaoDTO>) {
  ...
  const renderFilterInput = (column: ColumnDef<DelegacaoDTO, unknown>) => {
