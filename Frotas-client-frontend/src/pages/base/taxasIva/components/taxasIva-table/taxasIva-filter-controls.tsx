...
import { filterFields } from '@/pages/base/taxasIva/components/taxasIva-table/taxasIva-constants'
...
export function TaxasIvaFilterControls({
  table,
  columns,
}: BaseFilterControlsProps<TaxaIvaDTO>) {
  ...
  const renderFilterInput = (column: ColumnDef<TaxaIvaDTO, unknown>) => {
