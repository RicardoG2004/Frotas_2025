...
import { filterFields } from './fornecedores-constants'

export function FornecedoresFilterControls({
  table,
  columns,
}: BaseFilterControlsProps<FornecedorDTO>) {
  ...
  const renderFilterInput = (column: ColumnDef<FornecedorDTO, unknown>) => {
