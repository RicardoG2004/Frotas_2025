...
import { useGetFornecedor } from '../../queries/fornecedores-queries'
import FornecedorUpdateForm from '../fornecedores-forms/fornecedor-update-form'
...
export function FornecedoresUpdatePage() {
  ...
  return (
    <div className='flex h-full flex-col gap-8 px-4 md:px-8 md:pb-8 md:pt-28 pt-14 md:mx-0 md:my-4 md:mr-4 md:rounded-xl pb-24'>
      <PageHead title='Atualizar Fornecedor | Base' />
      ...
      <div className='flex items-center gap-4'>
        ...
        <Breadcrumbs
          items={[
            ...
            {
              title: 'Fornecedores',
              link: '/utilitarios/tabelas/configuracoes/fornecedores',
            },
            {
              title: 'Atualizar',
              link: `/utilitarios/tabelas/configuracoes/fornecedores/update?fornecedorId=${fornecedorId}&instanceId=${instanceId}`,
            },
          ]}
        />
      </div>
