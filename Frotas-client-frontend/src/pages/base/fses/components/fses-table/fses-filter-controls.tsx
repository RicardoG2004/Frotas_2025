...
import { filterFields } from './fses-constants'

export function FsesFilterControls({
  table,
  columns,
}: BaseFilterControlsProps<FseDTO>) {
  ...
  const renderFilterInput = (column: ColumnDef<FseDTO, unknown>) => {
