...
import { filterFields } from './manutencoes-constants'

export function ManutencoesFilterControls({
  table,
  columns,
}: BaseFilterControlsProps<ManutencaoDTO>) {
  ...
  const renderFilterInput = (
    column: ColumnDef<ManutencaoDTO, unknown>
  ) => {
