...
import { filterFields } from '@/pages/frotas/cores/components/cores-table/cores-constants'
...
export function CoresFilterControls({
  table,
  columns,
}: BaseFilterControlsProps<CorDTO>) {
  ...
  const renderFilterInput = (column: ColumnDef<CorDTO, unknown>) => {
