...
import { filterFields } from './modelos-constants'

export function ModelosFilterControls({
  table,
  columns,
}: BaseFilterControlsProps<ModeloDTO>) {
  ...
  const renderFilterInput = (column: ColumnDef<ModeloDTO, unknown>) => {
