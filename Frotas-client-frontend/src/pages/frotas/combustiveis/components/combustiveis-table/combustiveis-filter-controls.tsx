...
import { filterFields } from './combustiveis-constants'

export function CombustiveisFilterControls({
  table,
  columns,
}: BaseFilterControlsProps<CombustivelDTO>) {
  ...
  const renderFilterInput = (column: ColumnDef<CombustivelDTO, unknown>) => {
