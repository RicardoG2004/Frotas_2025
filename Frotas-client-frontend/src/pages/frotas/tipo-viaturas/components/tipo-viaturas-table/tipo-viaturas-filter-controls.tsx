...
import { filterFields } from './tipo-viaturas-constants'

export function TipoViaturasFilterControls({
  table,
  columns,
}: BaseFilterControlsProps<TipoViaturaDTO>) {
  ...
  const renderFilterInput = (column: ColumnDef<TipoViaturaDTO, unknown>) => {
