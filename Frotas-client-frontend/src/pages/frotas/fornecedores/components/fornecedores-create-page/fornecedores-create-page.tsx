...
import FornecedorCreateForm from '@/pages/frotas/fornecedores/components/fornecedores-forms/fornecedor-create-form'
...
export function FornecedoresCreatePage() {
  ...
  return (
    <div className='flex h-full flex-col gap-8 px-4 md:px-8 md:pb-8 md:pt-28 pt-14 md:mx-0 md:my-4 md:mr-4 md:rounded-xl pb-24'>
      <PageHead title='Criar Fornecedor | Frotas' />
      ...
      <div className='flex items-center gap-4'>
        ...
        <Breadcrumbs
          items={[
            ...
            {
              title: 'Criar',
              link: `/frotas/configuracoes/fornecedores/create?instanceId=${instanceId}`,
            },
          ]}
        />
      </div>
