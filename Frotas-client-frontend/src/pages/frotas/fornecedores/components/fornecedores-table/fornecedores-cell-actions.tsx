...
import { useDeleteFornecedor } from '@/pages/frotas/fornecedores/queries/fornecedores-mutations'
...
export const CellAction = ({ data }: CellActionProps) => {
  ...
  const handleUpdateClick = (fornecedor: FornecedorDTO) => {
    ...
    navigate(
      `/frotas/configuracoes/fornecedores/update?fornecedorId=${fornecedor.id}&instanceId=${instanceId}`
    )
  }
