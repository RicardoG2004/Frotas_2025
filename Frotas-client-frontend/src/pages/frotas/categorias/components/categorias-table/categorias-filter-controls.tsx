...
import { filterFields } from './categorias-constants'

export function CategoriasFilterControls({
  table,
  columns,
}: BaseFilterControlsProps<CategoriaDTO>) {
  ...
  const renderFilterInput = (column: ColumnDef<CategoriaDTO, unknown>) => {
