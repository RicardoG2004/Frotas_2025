...
import { filterFields } from './marcas-constants'

export function MarcasFilterControls({
  table,
  columns,
}: BaseFilterControlsProps<MarcaDTO>) {
  ...
  const renderFilterInput = (column: ColumnDef<MarcaDTO, unknown>) => {
