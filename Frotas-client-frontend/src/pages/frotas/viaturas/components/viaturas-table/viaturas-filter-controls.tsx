...
import { filterFields } from './viaturas-constants'

export function ViaturasFilterControls({
  table,
  columns,
}: BaseFilterControlsProps<ViaturaDTO>) {
  ...
  const renderFilterInput = (column: ColumnDef<ViaturaDTO, unknown>) => {
