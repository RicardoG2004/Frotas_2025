...
import { filterFields } from './equipamentos-constants'

export function EquipamentosFilterControls({
  table,
  columns,
}: BaseFilterControlsProps<EquipamentoDTO>) {
  ...
  const renderFilterInput = (
    column: ColumnDef<EquipamentoDTO, unknown>
  ) => {
