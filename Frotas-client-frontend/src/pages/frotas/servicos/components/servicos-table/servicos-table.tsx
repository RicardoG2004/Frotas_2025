...
import { useDeleteMultipleServicos } from '../../queries/servicos-mutations'
import { columns } from './servicos-columns'
import { ServicosFilterControls } from './servicos-filter-controls'

type TServicosTableProps = {
  servicos: ServicoDTO[]
  page: number
  pageSize: number
  total: number
...
export function ServicosTable({
  ...
  const deleteMultipleServicosMutation =
    useDeleteMultipleServicos()
  ...
  const { isDeleteModalOpen, setIsDeleteModalOpen, handleDeleteSelected } =
    useDeleteHandler(
      deleteMultipleServicosMutation,
      'Serviços excluídos com sucesso',
      'Erro ao excluir serviços',
      state.selectedRows,
      undefined, // onSuccess callback
      'Alguns serviços foram excluídos com avisos', // partial success message
      (deletedIds: string[]) => {
      ...
      {servicos && (
        <>
          <DataTable
            ...
            FilterControls={ServicosFilterControls}
            toolbarActions={[
              {
                label: 'Remover',
          ...
          <AlertModal
            ...
            loading={deleteMultipleServicosMutation.isPending}
            title='Remover Serviços'
            description='Tem certeza que deseja remover os serviços selecionados?'
          />
        </>
      )}
    </>
