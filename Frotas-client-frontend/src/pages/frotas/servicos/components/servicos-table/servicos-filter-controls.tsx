...
import { filterFields } from './servicos-constants'

export function ServicosFilterControls({
  table,
  columns,
}: BaseFilterControlsProps<ServicoDTO>) {
  ...
  const renderFilterInput = (
    column: ColumnDef<ServicoDTO, unknown>
  ) => {
