...
import { filterFields } from './seguradoras-constants'

export function SeguradorasFilterControls({
  table,
  columns,
}: BaseFilterControlsProps<SeguradoraDTO>) {
  ...
  const renderFilterInput = (column: ColumnDef<SeguradoraDTO, unknown>) => {
