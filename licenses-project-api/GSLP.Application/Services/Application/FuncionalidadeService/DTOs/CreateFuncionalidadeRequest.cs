...
{
    public class CreateFuncionalidadeRequest : IDto
    {
    ...
    public class CreateFuncionalidadeValidator : AbstractValidator<CreateFuncionalidadeRequest>
    {
        public CreateFuncionalidadeValidator()
        {
            _ = RuleFor(x => x.Nome)
