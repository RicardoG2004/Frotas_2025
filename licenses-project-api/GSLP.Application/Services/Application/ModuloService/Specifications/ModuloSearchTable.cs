...
{
    public class ModuloSearchTable : Specification<Modulo>
    {
        public ModuloSearchTable(List<TableFilter> filters, string? dynamicOrder = "")
        {
            // Apply filters
                ...
                foreach (var filter in filters)
                {
                    switch (filter.Id.ToLower())
                    {
                        ...
                        case "areaid":
                            ...
                            {
                                _ = Query.Where(x => x.Aplicacao.AreaId == areaId);
                            }
                            break;
                    }
                }
