...
{
    public class UpdateAplicacaoRequest : IDto
    {
    ...
    public class UpdateAplicacaoValidator : AbstractValidator<UpdateAplicacaoRequest>
    {
        public UpdateAplicacaoValidator()
        {
            _ = RuleFor(x => x.Nome)
