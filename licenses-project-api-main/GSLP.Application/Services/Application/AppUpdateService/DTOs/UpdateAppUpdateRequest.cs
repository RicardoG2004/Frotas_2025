...
{
  public class UpdateAppUpdateRequest : IDto
  {
    ...
    // Obrigatorio removed from update - field cannot be updated via this endpoint
  ...
  public class UpdateAppUpdateValidator : AbstractValidator<UpdateAppUpdateRequest>
  {
    public UpdateAppUpdateValidator()
    {
