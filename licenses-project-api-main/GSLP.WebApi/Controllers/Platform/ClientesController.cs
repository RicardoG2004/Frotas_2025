...
namespace GSLP.WebApi.Controllers.Platform
{
    ...
    public class ClientesController : ControllerBase
    {
        ...
        [Authorize(Roles = "root, administrator")]
        [HttpGet("by-aplicacao/{aplicacaoId}")]
        public async Task<IActionResult> GetClientesByAplicacaoResponseAsync(Guid aplicacaoId)
        {
            Response<IEnumerable<ClienteDTO>> result =
                await _ClienteService.GetClientesByAplicacaoResponseAsync(aplicacaoId);
            return Ok(result);
        }
