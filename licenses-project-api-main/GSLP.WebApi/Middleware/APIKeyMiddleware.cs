  ...
  public class APIKeyMiddleware
  {
    ...
    public async Task InvokeAsync(HttpContext context)
    {
      ...
      try
      {
        ...
        {
          _logger.LogWarning(
            "[APIKeyMiddleware] Request rejected - API key not found in database. Method: {Method}, Path: {Path}, APIKey: {APIKey}, ClientIP: {ClientIP}",
            requestMethod,
            requestPath,
            APIKey,
            clientIp ?? "Unknown"
        ...
        {
          _logger.LogWarning(
            "[APIKeyMiddleware] Request rejected - API key is inactive. Method: {Method}, Path: {Path}, APIKey: {APIKey}, LicencaId: {LicencaId}, ClientIP: {ClientIP}",
            requestMethod,
            requestPath,
            APIKey,
        ...
        {
          _logger.LogWarning(
            "[APIKeyMiddleware] Request rejected - License is inactive or missing. Method: {Method}, Path: {Path}, APIKey: {APIKey}, LicencaId: {LicencaId}, ClientIP: {ClientIP}",
            requestMethod,
            requestPath,
            APIKey,
            licencaAPIKey.LicencaId,
        ...
        {
          _logger.LogWarning(
            "[APIKeyMiddleware] Request rejected - License is blocked. Method: {Method}, Path: {Path}, APIKey: {APIKey}, LicencaId: {LicencaId}, MotivoBloqueio: {MotivoBloqueio}, ClientIP: {ClientIP}",
            requestMethod,
            requestPath,
            APIKey,
            licencaAPIKey.LicencaId,
        ...
        _logger.LogInformation(
          "[APIKeyMiddleware] Request authorized - Method: {Method}, Path: {Path}, APIKey: {APIKey}, LicencaId: {LicencaId}, ClienteId: {ClienteId}, ClientIP: {ClientIP}",
          requestMethod,
          requestPath,
          APIKey,
