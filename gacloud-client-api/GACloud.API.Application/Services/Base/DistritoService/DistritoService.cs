...
using GACloud.API.Application.Services.Base.DistritoService.Specifications;
using GACloud.API.Application.Utility;
using GACloud.API.Domain.Entities.Base;
using Microsoft.EntityFrameworkCore;

// After creating this service:
// -- 1. Create a Distrito domain entity in GACloud.API.Domain/Entities/Catalog
// -- 2. Add DbSet<Distrito> to GACloud.API.Infrastructure/Persistence/Contexts/ApplicationDbContext and create a new migration
