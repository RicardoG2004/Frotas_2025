...
using GACloud.API.Application.Services.Base.FreguesiaService.Specifications;
using GACloud.API.Application.Utility;
using GACloud.API.Domain.Entities.Base;
using Microsoft.EntityFrameworkCore;

// After creating this service:
// -- 1. Create a Freguesia domain entity in GACloud.API.Domain/Entities/Catalog
// -- 2. Add DbSet<Freguesia> to GACloud.API.Infrastructure/Persistence/Contexts/ApplicationDbContext and create a new migration
