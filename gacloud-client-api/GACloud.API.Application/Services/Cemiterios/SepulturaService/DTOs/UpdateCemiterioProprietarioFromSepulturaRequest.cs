...
{
  public class UpdateProprietarioFromSepulturaRequest : IDto
  {
  ...
  public class UpdateProprietarioFromSepulturaValidator
    : AbstractValidator<UpdateProprietarioFromSepulturaRequest>
  {
    public UpdateProprietarioFromSepulturaValidator()
    {
