...
{
  public class CreateSepulturaRequest : IDto
  {
    ...
    public List<CreateProprietarioFromSepulturaRequest>? Proprietarios { get; set; }
  }

  public class CreateSepulturaValidator
    : AbstractValidator<CreateSepulturaRequest>
  {
    public CreateSepulturaValidator()
    {
