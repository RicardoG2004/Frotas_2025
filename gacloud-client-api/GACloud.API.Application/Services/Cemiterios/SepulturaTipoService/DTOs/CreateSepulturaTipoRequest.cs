...
{
  public class CreateSepulturaTipoRequest : IDto
  {
    public required string Nome { get; set; }
    public required string EpocaId { get; set; }
    public required string SepulturaTipoDescricaoId { get; set; }
  ...
  public class CreateSepulturaTipoValidator
    : AbstractValidator<CreateSepulturaTipoRequest>
  {
    public CreateSepulturaTipoValidator()
    {
      _ = RuleFor(x => x.Nome).NotEmpty();
      _ = RuleFor(x => x.EpocaId).NotEmpty();
      _ = RuleFor(x => x.SepulturaTipoDescricaoId).NotEmpty();
    }
  }
}
