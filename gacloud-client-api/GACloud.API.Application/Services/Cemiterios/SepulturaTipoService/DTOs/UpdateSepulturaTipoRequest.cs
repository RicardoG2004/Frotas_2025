...
{
  public class UpdateSepulturaTipoRequest : IDto
  {
  ...
  public class UpdateSepulturaTipoValidator
    : AbstractValidator<UpdateSepulturaTipoRequest>
  {
    public UpdateSepulturaTipoValidator()
    {
