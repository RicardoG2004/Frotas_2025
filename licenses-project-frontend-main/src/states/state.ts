...
class State {
   ...
   *
   * Supports separate environment variables:
   * - VITE_URL_HTTP for HTTP environments
   * - VITE_URL_HTTPS for HTTPS environments
   *
   * Falls back to VITE_URL if protocol-specific variables are not set
   */
  public get URL(): string {
    return getApiUrl('VITE_URL')
  }
