...
import { filterFields } from '@/pages/base/rubricas/components/rubricas-table/rubricas-constants'
...
export function RubricasFilterControls({
  table,
  columns,
}: BaseFilterControlsProps<RubricaDTO>) {
  ...
  const renderFilterInput = (column: ColumnDef<RubricaDTO, unknown>) => {
      ...
      return (
        ...
        >
          ...
          <SelectContent>
            ...
            {Object.entries(RubricaTipoLabel).map(([value, label]) => (
