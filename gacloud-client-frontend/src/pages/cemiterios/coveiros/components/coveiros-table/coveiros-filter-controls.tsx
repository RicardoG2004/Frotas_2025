...
import { filterFields } from './coveiros-constants'

export function CoveirosFilterControls({
  table,
  columns,
}: BaseFilterControlsProps<CoveiroDTO>) {
  ...
  const renderFilterInput = (column: ColumnDef<CoveiroDTO, unknown>) => {
