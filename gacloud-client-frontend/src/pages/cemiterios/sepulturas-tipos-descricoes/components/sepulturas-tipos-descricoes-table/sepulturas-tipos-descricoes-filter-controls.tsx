...
import { filterFields } from '@/pages/cemiterios/sepulturas-tipos-descricoes/components/sepulturas-tipos-descricoes-table/sepulturas-tipos-descricoes-constants'
...
export function SepulturasTiposDescricoesFilterControls({
  table,
  columns,
}: BaseFilterControlsProps<SepulturaTipoGeralDTO>) {
  ...
  const renderFilterInput = (
    column: ColumnDef<SepulturaTipoGeralDTO, unknown>
  ) => {
