...
import { filterFields } from '@/pages/cemiterios/cemiterios/components/cemiterios-table/cemiterios-constants'
...
export function CemiteriosFilterControls({
  table,
  columns,
}: BaseFilterControlsProps<CemiterioDTO>) {
  ...
  const renderFilterInput = (column: ColumnDef<CemiterioDTO, unknown>) => {
