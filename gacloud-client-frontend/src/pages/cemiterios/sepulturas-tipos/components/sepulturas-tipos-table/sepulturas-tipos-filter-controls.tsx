...
import { filterFields } from './sepulturas-tipos-constants'

export function SepulturasTiposFilterControls({
  table,
  columns,
}: BaseFilterControlsProps<SepulturaTipoDTO>) {
  ...
  const renderFilterInput = (column: ColumnDef<SepulturaTipoDTO, unknown>) => {
