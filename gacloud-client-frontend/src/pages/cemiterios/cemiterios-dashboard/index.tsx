...
export function CemiteriosDashboardPage() {
  ...
  const quickActions = [
    ...
    },
    {
      ...
      color: useIconThemeColor('/cemiterios/configuracoes/marcas'),
      openInNewWindow: true,
    },
  ]
          ...
          <div className='mb-4'>
            <div className='flex items-center gap-4 mb-3'>
              <div className='p-3 rounded-md bg-gradient-to-br from-primary/15 to-primary/5 border border-primary/20 shadow-sm'>
                <Icons.IconGrave className='h-6 w-6 text-primary' />
              </div>
              <div>
                ...
                <p className='text-muted-foreground/80 text-sm mt-1'>
                  Aceda rapidamente às principais funcionalidades dos cemitérios
                </p>
              </div>
            </div>
          </div>
