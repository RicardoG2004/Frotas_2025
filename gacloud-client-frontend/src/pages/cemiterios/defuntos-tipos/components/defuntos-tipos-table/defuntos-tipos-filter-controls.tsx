...
import { filterFields } from '@/pages/cemiterios/defuntos-tipos/components/defuntos-tipos-table/defuntos-tipos-constants'
...
export function DefuntosTiposFilterControls({
  table,
  columns,
}: BaseFilterControlsProps<DefuntoTipoDTO>) {
  ...
  const renderFilterInput = (column: ColumnDef<DefuntoTipoDTO, unknown>) => {
