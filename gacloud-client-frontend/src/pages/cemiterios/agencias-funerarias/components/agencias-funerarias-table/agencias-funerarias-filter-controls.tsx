...
import { filterFields } from './agencias-funerarias-constants'

export function AgenciasFunerariasFilterControls({
  table,
  columns,
}: BaseFilterControlsProps<AgenciaFunerariaDTO>) {
  ...
  const renderFilterInput = (
    column: ColumnDef<AgenciaFunerariaDTO, unknown>
  ) => {
