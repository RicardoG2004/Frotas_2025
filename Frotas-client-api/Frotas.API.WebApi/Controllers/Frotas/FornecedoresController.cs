...
using Frotas.API.Application.Services.Frotas.FornecedorService;
...
{
  [Route("client/frotas/fornecedores")]
  [ApiController]
  public class FornecedoresController(IFornecedorService FornecedorService)
    : ControllerBase
  {
