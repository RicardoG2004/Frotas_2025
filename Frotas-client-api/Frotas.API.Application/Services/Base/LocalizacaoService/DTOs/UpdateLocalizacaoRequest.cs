...
{
    public class UpdateLocalizacaoRequest : IDto
    {
    ...
    public class UpdateLocalizacaoValidator : AbstractValidator<UpdateLocalizacaoRequest>
    {
        public UpdateLocalizacaoValidator()
        {
