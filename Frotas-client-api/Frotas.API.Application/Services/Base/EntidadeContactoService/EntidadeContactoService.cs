...
using Frotas.API.Application.Services.Base.EntidadeContactoService.Filters;
using Frotas.API.Application.Services.Base.EntidadeContactoService.Specifications;
using Frotas.API.Application.Utility;
using Frotas.API.Domain.Entities.Base;

// After creating this service:
// -- 1. Create a EntidadeContacto domain entity in Frotas.API.Domain/Entities/Catalog
// -- 2. Add DbSet<EntidadeContacto> to Frotas.API.Infrastructure/Persistence/Contexts/ApplicationDbContext and create a new migration
...
namespace Frotas.API.Application.Services.Base.EntidadeContactoService
{
