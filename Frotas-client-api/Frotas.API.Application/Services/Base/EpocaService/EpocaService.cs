...
using Frotas.API.Application.Services.Base.EpocaService.Specifications;
using Frotas.API.Application.Utility;
using Frotas.API.Domain.Entities.Base;
using Microsoft.EntityFrameworkCore;

// After creating this service:
// -- 1. Create a Epoca domain entity in Frotas.API.Domain/Entities/Catalog
// -- 2. Add DbSet<Epoca> to Frotas.API.Infrastructure/Persistence/Contexts/ApplicationDbContext and create a new migration
