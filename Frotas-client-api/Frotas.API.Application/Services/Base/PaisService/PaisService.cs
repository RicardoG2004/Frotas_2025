...
using Frotas.API.Application.Services.Base.PaisService.Specifications;
using Frotas.API.Application.Utility;
using Frotas.API.Domain.Entities.Base;
using Microsoft.EntityFrameworkCore;

// After creating this service:
// -- 1. Create a Pais domain entity in Frotas.API.Domain/Entities/Catalog
// -- 2. Add DbSet<Pais> to Frotas.API.Infrastructure/Persistence/Contexts/ApplicationDbContext and create a new migration
