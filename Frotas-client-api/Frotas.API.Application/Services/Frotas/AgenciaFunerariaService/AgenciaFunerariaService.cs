...
using Frotas.API.Application.Services.Frotas.AgenciaFunerariaService.Specifications;
using Frotas.API.Application.Utility;
using Frotas.API.Domain.Entities.Frotas;
using Microsoft.EntityFrameworkCore;

// After creating this service:
// -- 1. Create a AgenciaFuneraria domain entity in Frotas.API.Domain/Entities/Frotas
// -- 2. Add DbSet<AgenciaFuneraria> to Frotas.API.Infrastructure/Persistence/Contexts/ApplicationDbContext and create a new migration
