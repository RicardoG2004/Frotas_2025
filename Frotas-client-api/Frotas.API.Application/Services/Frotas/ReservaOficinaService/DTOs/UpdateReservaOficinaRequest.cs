...
{
  public class UpdateReservaOficinaRequest : IDto
  {
  ...
  public class UpdateReservaOficinaValidator : AbstractValidator<UpdateReservaOficinaRequest>
  {
    public UpdateReservaOficinaValidator()
    {
